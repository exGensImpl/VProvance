...
import VProvance.Core.Database.DataUnreachableReason;
import VProvance.Core.Database.DataUnreachableException;
import VProvance.Core.Database.UserInfo;
...
public class AuthDialog extends javax.swing.JDialog {
    ...
    private final String _expectedRole;
    /**
     * Creates new form AuthDialog
     */
    public AuthDialog(String expectedRole, java.awt.Frame parent, boolean modal) {
        super(parent, modal);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AuthDialog dialog = new AuthDialog(null, new javax.swing.JFrame(), true);
    ...
    public boolean _isValidAuthParams = false;
    
    public boolean isValidAuthParams() {
        return _isValidAuthParams;
    }
    ...
    private void initComponents() {
        ...
        jPasswordField.setText("vinodel");
