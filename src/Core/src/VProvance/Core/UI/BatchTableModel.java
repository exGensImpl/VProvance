...
public class BatchTableModel implements TableModel  {
    ...
    private List<UsefullBatch> _batches;
    private IBatchSource _source;
    
    public BatchTableModel()
    {
        this(new DefaultBatchSource());
    }
    
    public BatchTableModel(IBatchSource source)
    {
        if (source == null) throw new NullPointerException("source");     
        _source = source;
        _batches = source.GetBatches();
    }
